...
const Banner = () => {
  return (
    <div className="w-full">
      <div className="bg-[url('https://ik.imagekit.io/i455l48ls/Banner.png')] bg-cover bg-center bg-no-repeat text-white mb-30 flex justify-between flex-col items-center w-full gap-5 h-150">
